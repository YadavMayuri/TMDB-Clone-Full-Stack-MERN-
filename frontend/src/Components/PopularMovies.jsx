...
const PopularMovies = () => {
    ...
    useEffect(() => {
        ...
        const fetchTrendingMovies = async () => {
            setLoading(true)
            try {
                const response = await axios.get('https://tmdb-clone-full-stack-mern.onrender.com/movies/getPopularmovies');
    ...
    return (
        <>
            <div className="w-[90%] m-auto ">
                <h1 className="my-6 font-bold text-2xl">Popular Movies</h1>
