...
const SinglePageDetails = () => {
    ...
    useEffect(() => {
        ...
        const fetchMovie = async () => {
            ...
            try {
                console.log(id);
                const response = await axios.get(`http://localhost:5000/movies/getSingleMovie/${id}&language=en-US`);
    ...
    //     url(https://image.tmdb.org/p/w440_and_h660_face/${movie.backdrop_path})`,
    ...
    const gradientStyle = {
        background: `linear-gradient(to bottom right, rgba(31.5, 31.5, 52.5, 1), rgba(31.5, 31.5, 52.5, 0.84)),
        url(https://image.tmdb.org/t/p/w440_and_h660_face/${movie.backdrop_path})`,
        backgroundSize: 'cover',
        backgroundPosition: 'center',
    };
